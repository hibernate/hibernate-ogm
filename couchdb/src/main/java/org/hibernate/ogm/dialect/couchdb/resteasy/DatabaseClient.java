 ...
 * methods return a Response<T> instead directly the T instance in order to have more information in case of
 * failures
 *
...
public interface DatabaseClient {
	 ...
	 * @return the Response with the searched CouchDBEntity
	 */
	@GET
	@Path("{id}")
	 ...
	 * @return the Response with the searched CouchDBKeyValue
	 */
	@GET
	@Path("{id}")
	 ...
	 * @return the Response with the {@link org.hibernate.ogm.dialect.couchdb.designdocument.EntityTupleRows}
	 */
	@GET
