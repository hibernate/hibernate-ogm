 ...
 * <p>
 * Tuples are stored in CouchDB documents obtained as a JSON serialization of a {@link EntityDocument} object. Associations are stored in CouchDB documents obtained as a JSON serialization of a
 * {@link AssociationDocument} object.
 * 
...
public class CouchDBDialect extends BaseGridDialect {
	...
	public boolean isStoredInEntityStructure(AssociationKeyMetadata associationKeyMetadata, AssociationTypeContext associationTypeContext) {
		AssociationStorageType associationStorage = associationTypeContext.getOptionsContext().getUnique(AssociationStorageOption.class);

		return associationKeyMetadata.isOneToOne() || (associationKeyMetadata.getAssociationKind() == AssociationKind.EMBEDDED_COLLECTION) || (associationStorage == AssociationStorageType.IN_ENTITY);
	}
