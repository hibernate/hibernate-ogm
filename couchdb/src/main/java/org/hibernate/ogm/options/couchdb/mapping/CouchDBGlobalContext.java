 ...
 */
public interface CouchDBGlobalContext extends GlobalContext<CouchDBGlobalContext, CouchDBEntityContext> {
	 ...
	 */
	CouchDBGlobalContext associationStorage(AssociationStorageType associationStorage);
}
