...
public final class Neo4jAssociationSnapshot implements AssociationSnapshot {
	...
	public Neo4jAssociationSnapshot(Node startNode, RelationshipType type, AssociationKey associationKey) {
	...
	private Iterable<Relationship> relationships() {
		return startNode.getRelationships( Direction.OUTGOING, relationshipType );
	}
