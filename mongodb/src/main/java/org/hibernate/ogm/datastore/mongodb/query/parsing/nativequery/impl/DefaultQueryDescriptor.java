 ...
 */
class DefaultQueryDescriptor extends AbstractQueryDescriptor {
	@Override
	public MongoDBQueryDescriptor build(String collection, MongoDBQueryDescriptor.Operation operation, String criteria, String projection, String orderBy, String options, String updateOrInsert,
		...
		return new MongoDBQueryDescriptor( collection, operation, parse( criteria ), parse( projection ), parse( orderBy ), parse( options ), parse( updateOrInsert ),null,null );
	}
}
