 ...
 * @author caust_000
 */
public class BasicMongoDBTupleSnapshot implements TupleSnapshot {
	...
	public BasicMongoDBTupleSnapshot(DBObject dbObject, String[] columnNames) {
		this.dbObject = dbObject;
		this.columnNames = columnNames;
	}

	public BasicMongoDBTupleSnapshot(DBObject dbObject, EntityKeyMetadata meta) {
