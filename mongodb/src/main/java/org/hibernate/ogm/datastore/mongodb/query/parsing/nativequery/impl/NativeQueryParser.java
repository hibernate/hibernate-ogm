...
public class NativeQueryParser extends BaseParser<MongoDBQueryDescriptorBuilder> {
	...
	public Rule Reserved() {
		return FirstOf( Find(), FindOne(), FindAndModify(), Insert(), InsertOne(), InsertMany(), Remove(), Update(), UpdateOne(), UpdateMany(), ReplaceOne(), Count(), Aggregate(), Distinct(), MapReduce() );
