 ...
 */
public class BytesAsBsonBinaryTypeDescriptor extends AbstractTypeDescriptor<byte[]> {

	public static final BytesAsBsonBinaryTypeDescriptor INSTANCE = new BytesAsBsonBinaryTypeDescriptor();

	public BytesAsBsonBinaryTypeDescriptor() {
		super( byte[].class );
	}
