...
public class MongoDBIndexSpec {
	...
	/**
	 * Optional. The name of the index. If unspecified, MongoDB generates an index name by concatenating the names of
	 * the indexed fields and the sort order. Whether user specified or MongoDB generated, index names including their
	 * full namespace (i.e. database.collection) cannot be longer than the Index Name Limit (that is 128 characters)
	 */
