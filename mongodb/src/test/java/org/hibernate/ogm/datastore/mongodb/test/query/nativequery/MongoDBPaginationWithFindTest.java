...
/**
 * Test pagination with a native find query in MongoDB.
 *
 * @author Davide D'Alto
 * @author Fabio Massimo Ercoli
 */
public class MongoDBPaginationWithFindTest extends PaginationUseCases {

	public static final String NATIVE_QUERY = "db." + Poem.TABLE_NAME + ".find( { '$query' : { 'author' : 'Oscar Wilde' }, '$orderby' : { 'name' : 1 } } )";
