...
/**
 * Testing MongoDB index creation
 *
...
public class MongoDBIndexTest extends OgmTestCase {
	...
	public void testSuccessfulIndexCreation() throws Exception {
		...
		assertJsonEquals( "{ 'v' : 1 , 'unique' : true , 'key' : { 'author' : 1 , 'name' : 1} , 'name' : 'author_name_idx' , 'ns' : 'ogm_test_database.T_POEM' , 'expireAfterSeconds' : 0}",
		...
		assertJsonEquals( "{ 'v' : 1 , 'key' : { 'name' : 1 , 'author' : 1} , 'name' : 'IDXjo3qu8pkq9vsofgrq58pacxfq' , 'ns' : 'ogm_test_database.T_POEM' , 'expireAfterSeconds' : 0}",
