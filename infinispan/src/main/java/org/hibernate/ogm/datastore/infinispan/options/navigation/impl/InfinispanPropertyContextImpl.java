 ...
 */
public abstract class InfinispanPropertyContextImpl extends BaseKeyValueStorePropertyContext<InfinispanEntityContext, InfinispanPropertyContext> implements
		InfinispanPropertyContext {

	public InfinispanPropertyContextImpl(ConfigurationContext context) {
		super( context );
	}
}
