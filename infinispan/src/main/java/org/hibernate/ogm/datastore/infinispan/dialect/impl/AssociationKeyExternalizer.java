...
public class AssociationKeyExternalizer implements AdvancedExternalizer<AssociationKey> {
	...
	public AssociationKey readObject(ObjectInput input) throws IOException, ClassNotFoundException {
		...
		AssociationKeyMetadata associationKeyMetadata = new AssociationKeyMetadata( tableName, columnNames, null, null, null, false, null );
		...
		return new AssociationKey( associationKeyMetadata, values, null, null );
	}
