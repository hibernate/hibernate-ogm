 ...
 */
public class PerTableSerializableAssociationKey implements Externalizable {
	...
	public PerTableSerializableAssociationKey() {
	}

	PerTableSerializableAssociationKey(AssociationKey key) {
	...
	public boolean equals(Object obj) {
		...
		PerTableSerializableAssociationKey other = (PerTableSerializableAssociationKey) obj;
	...
	public String toString() {
		return "SerializableAssociationKey [columnNames=" + Arrays.toString( columnNames ) + ", columnValues="
