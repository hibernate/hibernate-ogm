 ...
 */
public class NoSqlMappingFactory implements MappingFactory<NoSqlGlobalContext> {

	@Override
	public Class<NoSqlGlobalContext> getMappingType() {
		return NoSqlGlobalContext.class;
	}

	@Override
	public MappingContext createMappingContext() {
		return new MappingContext( NoSqlGlobalContext.class, generators() );
	}
