 ...
 */
public abstract class Option<I, T extends Option<I, T>> implements OptionsContainerAware {
	...
	private Class<T> getType() {
		ResolvedType type = typeResolver.resolve( getClass() );
		List<ResolvedType> typeParametersFor = type.typeParametersFor( Option.class );
		@SuppressWarnings("unchecked")
		Class<T> optionType = (Class<T>) typeParametersFor.get( 1 ).getErasedType();
		return optionType;
	}
