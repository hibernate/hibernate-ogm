...
public interface MappingService extends Service {
	MappingServiceContext withSession(SessionImplementor session);

	interface MappingServiceContext {
		List<Object> getGlobalOptions();
		List<Object> getEntityOptions(Class<?> entityType);
		List<Object> getPropertyOptions(Class<?> entityType, String propertyName);
	}
}
