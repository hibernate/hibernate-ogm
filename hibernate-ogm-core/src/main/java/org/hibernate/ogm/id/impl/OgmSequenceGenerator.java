...
public class OgmSequenceGenerator implements PersistentIdentifierGenerator, Configurable {
    ...
    public void configure(Type type, Properties params, Dialect dialect) throws MappingException {
        ...
        tableGenerator.setSegmentValue( determineSequenceName( params ) );
    ...
    String determineSequenceName(Properties params) {
        return PropertiesHelper.getString( SEQUENCE_NAME,
                                           params,
    ...
    public Serializable generate(final SessionImplementor session, Object object) throws HibernateException {
        return tableGenerator.getOptimizer().generate(
				new AccessCallback() {
					public IntegralDataTypeHolder getNextValue() {
						return ( IntegralDataTypeHolder ) tableGenerator.doWorkInIsolationTransaction( session );
					}
				}
		);
    }
