...
public class OptionContainerHelper {
	...
	public static Set<Option<?,?>> options(MappingContext context) {
		return asSet( context.getGlobalOptions() );
	}

	public static Set<Option<?,?>> options(MappingContext context, Class<?> clazz) {
		OptionsContainer container = context.getOptionsPerEntity().get( clazz );
		return asSet( container );
	}

	public static Set<Option<?,?>> options(MappingContext context, Class<?> clazz, String property) {
	...
	private static Set<Option<?, ?>> asSet(OptionsContainer container) {
