...
public class JPAInheritanceTest {
	...
	@Test
	public void testJPAInheritance() throws Exception {
		...
		SuperHero lsh = em.find( SuperHero.class, sh.getName() );
		assertThat( lsh ).isNotNull();
		assertThat( sh.getSpecialPower() ).isEqualTo( lsh.getSpecialPower() );
		em.remove( lh );
		em.remove( lsh );
