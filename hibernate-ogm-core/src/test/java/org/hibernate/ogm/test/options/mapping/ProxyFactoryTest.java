...
public class ProxyFactoryTest {
	...
	public void testProxyGeneration() throws Exception {
		...
		MappingContext context = new MappingContext(SampleMappingModel.SampleGlobalContext.class, generators);
		SampleMappingModel.SampleGlobalContext sampleMapping = ConfigurationProxyFactory.get( SampleMappingModel.SampleGlobalContext.class, context );
		sampleMapping
				.force( true )
