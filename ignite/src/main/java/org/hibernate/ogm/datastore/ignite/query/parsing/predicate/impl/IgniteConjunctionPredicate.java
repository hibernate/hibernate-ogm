 ...
 */
public class IgniteConjunctionPredicate extends ConjunctionPredicate<StringBuilder> implements NegatablePredicate<StringBuilder> {

	private final StringBuilder builder;

	public IgniteConjunctionPredicate(StringBuilder builder) {
