...
public class WebSphereTransaction implements Transaction {
    ...
    public boolean enlistResource(final XAResource xaResource) throws RollbackException, IllegalStateException, SystemException {
        ...
        return delegate.enlistResource((XAResource) newProxyInstance(currentThread().getContextClassLoader(),
    ...
    @Override
    public void registerSynchronization(final javax.transaction.Synchronization sync) throws RollbackException, IllegalStateException,
            SystemException {
