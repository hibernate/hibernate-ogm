...
and `org.hibernate.ogm:hibernate-ogm-infinispan-embedded:{hibernate-ogm-version}`
...
[NOTE]
====
If you're deploying your application onto WildFly {wildfly-short-version},
...
If you want to use Hibernate OGM with http://wildfly.org/[WildFly {wildfly-short-version}] you will need some
