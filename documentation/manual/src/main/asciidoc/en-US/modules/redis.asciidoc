...
Key: Associations:AccountWithPhone:mobileNumbers:2
[
   "+1-222-555-0222",
   "+1-202-555-0333"
]
...
[source, JSON]
----
Key: Associations:GrandMother_grandChildren:grandChildren:86ada718-f2a2-4299-b6ac-3d90b1ef2331
...
"Associations:<%ASSOCIATION_TABLE%>:<%COLLECTION_ROLE%>:<%ASSOCIATION_ID%>", e.g. "Associations:AccountOwner:BankAccount:4f5b48ad-f074-4a64-8cf4-1f9c54a33f76".
...
[source, JSON]
----
Key: Associations:Basket_Product:products:davide_basket
[
   "Beer",
   "Pretzel"
]
