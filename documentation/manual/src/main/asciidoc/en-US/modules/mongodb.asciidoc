...
* the result of a native query must be mapped by one entity

If your use case meet this restrictions you can execute a native query like
...
running a SQL query but the +Session+ API was initially thought for relationa databases
