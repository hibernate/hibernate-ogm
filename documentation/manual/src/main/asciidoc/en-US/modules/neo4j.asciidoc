...
The name of the relationships depends on the type of association, but in general, it is the corresponding name of the table
...
Hibernate OGM also supports native http://docs.neo4j.org/chunked/stable/cypher-query-lang.html[Cypher queries] for Neo4j.
