...
Other possible values are +DROP_RECREATE_QUIETLY+ and +RECREATE_QUIETLY+ but the effect will be
the same (since Neo4j constraints don't have a name): keep the existing constraints and create the missing one.
...
[subs="verbatim,attributes"]
----
(:Wife:ENTITY { id: 1, name: "Karen" }) - [:Husband] - (:Husband:ENTITY {id: 2, name: "Mark"})
----
