...
The properties of an +@Emebddable+ element are stored as dot-separated properties in the owner node.
...
Note that in the previous example no property is added to the relationships;
