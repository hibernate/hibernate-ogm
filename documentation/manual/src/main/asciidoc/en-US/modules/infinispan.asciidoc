...
<infinispan
    ...
    <namedCache name="Order">
    </namedCache>

    <namedCache name="associations_User_Order">
    </namedCache>
...
we will likely want to configure clustering modes, eviction policies and ++CacheStore++s.
...
<namedCache name="User">
  ...
  <loaders passivation="true" shared="false">
    <singleFile location="/var/infinispan/myapp/users" />
  </loaders>
</namedCache>
----
...
all the properties names and values respectively as keys and values of the map.
