...
[WARNING]
====
The pre-package module for EAP 6 is  *experimental*.
The content of the existing modules for _javax.persistence.api_, _javax.ws.rs.api:main_ and _org.javassist:main_ in EAP 6 will be replaced with the versions required by OGM.
