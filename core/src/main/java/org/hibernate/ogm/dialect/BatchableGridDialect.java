...
public interface BatchableGridDialect extends GridDialect {
	...
	/**
	 * Called before calling the method of the {@link GridDialect}, it is used to initialise the dialect for the
	 * execution of batched operations
	 */
	void prepareBatch();
	...
	/**
	 * Called to cancel the executions of batched operations and release resources
	 */
	void clearBatch();
