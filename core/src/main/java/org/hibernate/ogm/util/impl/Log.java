...
public interface Log extends BasicLogger {
	...
	@Message(id = 90, value = "Projection and addEntity are not allowed in the same query: table <%1$s>.")
	HibernateException addEntityNotAllowedInNativeQueriesUsingProjection( String table );
}
