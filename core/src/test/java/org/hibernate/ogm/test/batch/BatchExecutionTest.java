...
/**
 * Test that the method {@link BatchableGridDialect#executeBatch(OperationsQueue)} is called when a dialect is a
 * {@link BatchableGridDialect}.
 *
...
public class BatchExecutionTest extends OgmTestCase {
	...
	@Test
	public void testBatchExecutionWhenFlushed() throws Exception {
	...
	protected void configure(Configuration cfg) {
		cfg.setProperty( DatastoreProviderInitiator.DATASTORE_PROVIDER, SampleBatchableDatastoreProvider.class.getName() );
	}
