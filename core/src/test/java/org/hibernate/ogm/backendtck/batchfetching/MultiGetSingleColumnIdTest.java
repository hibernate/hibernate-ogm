 ...
 */
@SkipByGridDialect(value = { GridDialectType.CASSANDRA, GridDialectType.COUCHDB, GridDialectType.INFINISPAN, GridDialectType.EHCACHE, GridDialectType.REDIS_HASH, GridDialectType.ORIENTDB, GridDialectType.ORIENTDB_REMOTE })
