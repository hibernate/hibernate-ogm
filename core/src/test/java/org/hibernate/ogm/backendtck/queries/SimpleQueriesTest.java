...
public class SimpleQueriesTest extends OgmTestCase {
	...
	@Test
	@SkipByGridDialect(value = { MONGODB, NEO4J, NEO4J_REMOTE }, comment = "Selecting from associations is not yet implemented.")
	...
	@Test
	@SkipByGridDialect(value = { MONGODB, NEO4J, NEO4J_REMOTE }, comment = "Projecting complete entity is not yet implemented.")
	...
	@Test
	@SkipByGridDialect(value = { MONGODB, NEO4J, NEO4J_REMOTE }, comment = "Doesn't apply to MongoDB or Neo4j queries.")
	...
	@Test
	@SkipByGridDialect(value = { MONGODB, NEO4J, NEO4J_REMOTE }, comment = "Selecting from associated entities is not yet implemented.")
	...
	@Test
	@SkipByGridDialect(value = { MONGODB, NEO4J, NEO4J_REMOTE }, comment = "Querying on associated entities is not yet implemented.")
	...
	public void testAutoFlushIsAppliedDuringQueryExecution() throws Exception {
		...
		if ( EnumSet.of( MONGODB, NEO4J, NEO4J_REMOTE ).contains( TestHelper.getCurrentDialectType() ) ) {
