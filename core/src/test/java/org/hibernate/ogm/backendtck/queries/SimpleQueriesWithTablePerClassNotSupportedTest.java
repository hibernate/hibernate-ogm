...
/**
 * Test that the dialect that are not supporting queries on polymorphic entities throw the right exception.
 *
 * @author Davide D'Alto
 */
@SkipByGridDialect({ HASHMAP, INFINISPAN, REDIS_HASH, REDIS_JSON, CASSANDRA, COUCHDB, EHCACHE })
