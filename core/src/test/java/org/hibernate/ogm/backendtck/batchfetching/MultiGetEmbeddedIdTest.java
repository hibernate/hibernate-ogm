 ...
 */
@SkipByGridDialect(value = { GridDialectType.CASSANDRA, GridDialectType.COUCHDB, GridDialectType.INFINISPAN, GridDialectType.INFINISPAN_REMOTE, GridDialectType.EHCACHE, GridDialectType.REDIS_HASH, GridDialectType.IGNITE })
