 ...
 */
@SkipByGridDialect(value = { GridDialectType.NEO4J_EMBEDDED, GridDialectType.NEO4J_REMOTE, GridDialectType.IGNITE }, comment = "Neo4j and Ignite are not compatible with HSEARCH 5")
