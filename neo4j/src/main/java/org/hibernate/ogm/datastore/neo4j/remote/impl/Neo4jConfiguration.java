...
public class Neo4jConfiguration {
	...
	public Neo4jConfiguration(ConfigurationPropertyReader propertyReader) {
		...
		this.connectionCheckoutTimeout = propertyReader.property( Neo4jProperties.CONNECTION_CHECKOUT_TMEOUT, Long.class ).getValue();
	...
	/**
	 * @see Neo4jProperties#CONNECTION_CHECKOUT_TMEOUT
	 * return Socket inactivity timeout in milliseconds
	 */
