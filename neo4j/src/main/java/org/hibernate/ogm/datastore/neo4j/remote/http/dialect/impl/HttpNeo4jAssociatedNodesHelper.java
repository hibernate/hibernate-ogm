...
public final class HttpNeo4jAssociatedNodesHelper {
	...
	public static Map<String, Node> findAssociatedNodes(HttpNeo4jClient client, Long txId, NodeWithEmbeddedNodes node, EntityKeyMetadata entityKeyMetadata, TupleContext tupleContext, HttpNeo4jEntityQueries queries) {
