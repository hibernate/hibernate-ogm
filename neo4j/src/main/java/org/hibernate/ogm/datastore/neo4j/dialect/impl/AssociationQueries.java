 ...
 */
public class AssociationQueries extends QueriesBase {
	...
	/*
	 * Example with target node: MATCH (n:ENTITY:table {id: {0}}) -[r:role] - (t {id: {1}}) RETURN r Example with
	 * relationship indexes: MATCH (n:ENTITY:table {id: {0}}) -[r:role {index: {1}}] - (t) RETURN r
	 */
	...
	/*
	 * MATCH (o:ENTITY:table1 {id: {0}}), (t:ENTITY:table2 {id: {1}}) CREATE UNIQUE (o) -[r:role {props}]-> (t) RETURN r
	 */
	...
	/*
	 * Example with association: MATCH (n:ENTITY:table {id: {0}}) -[r:role] - () DELETE r Example with an embedded
	 * association: MATCH (n:ENTITY:table {id: {0}}) -[a:role] - (e:EMBEDDED) WITH a, e MATCH path=(e) -[*0..]->
	 * (:EMBEDDED) FOREACH (r IN relationships(path) | DELETE r) FOREACH (e IN nodes(path) | DELETE e) DELETE a
	 */
	...
	/*
	 * Example with association: MATCH (n:ENTITY:table {id: {0}}) -[r:role] - (e) DELETE r Example with embedded
	 * collection: MATCH (n:ENTITY:table {id: {0}}) -[r:role] - (e:EMBEDDED) DELETE r, e Example with indexes: MATCH
	 * (n:ENTITY:table {id: {0}}) -[r:role {index: {1}}] - (e) DELETE r
	 */
	 ...
	 *
	 * MERGE (owner) -[:relType]-> (e0:EMBEDDED) -[:relType2]-> (e:EMBEDDED) CREATE (e)
	 * -[r:relType2]-> (new:EMBEDDED { property: {1}}) RETURN r MATCH (owner:ENTITY:table {id: {0}}) CREATE (owner)
	 * -[r:relType2]-> (target:EMBEDDED { property: {1}}) RETURN r
	 */
