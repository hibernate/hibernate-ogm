...
public final class Neo4jProperties implements OgmProperties {
	 ...
	 */
	public static String SOCKET_TIMEOUT = "hibernate.ogm.neo4j.client.socketTimeout";

	/**
	 * How long will we wait (in milliseconds) to get a connection?
	 */
	public static final String CONNECTION_CHECKOUT_TMEOUT = "hibernate.ogm.neo4j.client.connection_checkout_timeout";
	 ...
	 */
	public static String TTL_TIMEOUT = "hibernate.ogm.neo4j.client.socketTimeOut";
