...
public class Neo4jTestHelper implements TestableGridDialect {
	...
	public Map<String, Object> extractEntityTuple(Session session, EntityKey key) {
		...
		TupleSnapshot snapshot = dialect.getTuple( key, GridDialectOperationContexts.emptyTupleContext(), transactionContext ).getSnapshot();
	...
	private TransactionContext transactionContext(Session session) {
