...
public class HotRodSearchIntegrationIT extends MagiccardsDatabaseScenario {
	...
	public static Archive<?> createTestArchive() {
		...
		ModulesHelper.addModulesDependencyDeclaration( webArchive, "org.hibernate.ogm:${hibernateOgmModuleSlot} services, org.hibernate.ogm.infinispan-remote:${hibernateOgmModuleSlot} services" );
		return webArchive;
	}
