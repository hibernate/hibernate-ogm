...
link:http://community.jboss.org/wiki/MavenGettingStarted-Users[on this webpage].
...
link:http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=7144274[Mac OS X JDK in particular]),
